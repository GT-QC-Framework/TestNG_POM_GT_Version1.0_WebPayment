...
public class HomePageScript_JXM extends CommonTestcase {
	...
	public void beforeClass(String browser, String version, String url) throws InterruptedException {
		...
		inititalReport("Nhutbm_Webpay_Vo_lam_truyen_ky_mobile.html");
...
//		verifyEqual(homePage.getText_Title_Game(), "Võ Lâm Truyền Kỳ Mobile");
		...
		if (eleMayChu != null) {
			...
			Thread.sleep(500);
			String locator = String.format(HomePageUI.LIST_ITEM_MAYCHU, "S1-Thái Sơn");
		...
		if (eleNhanVat != null) {
			...
			Thread.sleep(500);
			String locator = String.format(HomePageUI.LIST_ITEM_NHANVAT, "GiinZingID");
	...
	public void beforeMethod() throws InterruptedException {
		...
		homePage.openUrl("https://pay.zing.vn/mobile/jxm/#/pay");
