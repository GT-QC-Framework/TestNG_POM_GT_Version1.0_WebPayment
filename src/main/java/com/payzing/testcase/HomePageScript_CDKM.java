...
public class HomePageScript_CDKM extends CommonTestcase {
	...
	public void beforeClass(String browser, String version, String url) throws InterruptedException {
		...
		inititalReport("Nhutbm_Webpay_Cung_Dinh_Ke_Mobile.html");
		...
		loginPage.inputTXT_TIMKIEMGAME("cung đình kế");
...
//		verifyEqual(homePage.getText_Title_Game(), "Võ Lâm Truyền Kỳ Mobile");
		...
		if (eleMayChu != null) {
			...
			Thread.sleep(500);
			String locator = String.format(HomePageUI.LIST_ITEM_MAYCHU, "S1-Võ Tắc Thiên");
		...
		if (eleNhanVat != null) {
			...
			Thread.sleep(500);
			String locator = String.format(HomePageUI.LIST_ITEM_NHANVAT, "GiinZingIDJJ");
...
//		homePage.clickPOPUP_XacNhan();
	...
	public void beforeMethod() throws InterruptedException {
		...
		homePage.openUrl("https://pay.zing.vn/mobile/cdkm/#/pay");
